  ...
  return (
    <div className='h-[8%] hidden lg:flex justify-between items-center text-white px-7 '>
      ...
      <div className="flex items-center pt-2 gap-3">
        <button className='rounded-full p-3 bg-black font-bold  px-7 cursor-pointer hover:scale-[1.08] '>Sign up</button>
        <button className='rounded-full p-3 bg-white text-black font-bold px-7 hover:scale-[1.08] cursor-pointer '>Log in</button>
      </div>
